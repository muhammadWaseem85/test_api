...
public class CustomTestNGReporter implements IReporter {
	...
	//private static final String emailableReportTemplateFile = "C:/pro/collabhub/src/test/java/web/custom/customize-emailable-report-template.html";
	private static final String emailableReportTemplateFile = "src/test/java/web/custom/customize-emailable-report-template.html";
	...
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
		...
		try
		{
			...
			String customReportTitle = this.getCustomReportTitle("Collab Hub Report");
